 ...
 * create project
 */
export const createProject = async (domain: string) => getJwtToken(`/project/create/${domain}`, {
    method: 'POST'
});
 ...
 * list project
 */
export const listProject = async (payload: IProjectPayload) =>
    getJwtToken('/project/index', payload);
...
export const getProjectInfo = async (payload) =>
    getJwtToken(`/project/show/${payload.domain}`, payload);